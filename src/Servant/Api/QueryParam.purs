...
newtype QueryParams r
  = QueryParams (Record r)
...
formatQueryString (QueryParams r) =
  let
    paramsList = hfoldlWithIndex QueryParamEntry ([] :: Array QueryParam) (r :: Record qp)
  in
    joinWith "&" <<< fromFoldable $ map formatParam paramsList
  where
